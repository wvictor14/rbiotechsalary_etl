with
    source as (select * from {{ source("survey_results", "src_responses_2022") }}),
    ...
    renamed as (
        ...
        select
            {{ dbt_utils.generate_surrogate_key(["'2022'", "timestamp"]) }}
            as response_id,
            2022 as survey_year,
            ...
            company_review,
            cast(null as varchar) as hours_worked_per_week,

            -- education and experience
            cast(null as varchar) as degrees,
            highest_achieved_formal_education as highest_education,
            cast(null as varchar) as postdoc_years,
            have_you_one_a_postdoc as did_postdoc,
            list_other_relevant_and_recognized_certifications as certifications,
            years_of_experience,
            cast(null as varchar) as years_at_current_position,

            -- compensation
            -- (compensation_options is dropped: sparse free text that
            -- duplicates compensation_stock_options)
            ...
            compensation_annual_equity as annual_equity,
            ...
            -- pre-2024 "Stock Options" question sat with the sign-on block
            compensation_stock_options as signon_stock_options,
            ...
            cast(null as varchar) as survey_feedback
